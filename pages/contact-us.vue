      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
        ...
        <div>
          ...
          <div class="flex items-center gap-8 mb-8">
            <div
              class="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-gray-300 text-sm text-gray-600"
            >
              <Clock class="h-4 w-4" />
              ...
              >
                ...
                <div>
                  <label
                    ...
                    class="block font-manrope text-sm font-medium text-[#374151] mb-2"
                  >
                    What can we help you with?<span class="text-red-500"
                      >*</span
                    >
                  </label>
                  <div class="relative">
                    <select
                      ...
                      :class="
                        formData.helpTopic ? 'text-[#111827]' : 'text-[#71717B]'
                      "
                    >
            ...
            <CardContent :class="'p-6'">
              <div class="space-y-6 sm:space-y-8 max-w-[542px]">
                ...
                <div>
                  ...
                  <h3 class="font-manrope font-semibold text-lg leading-8 mb-2">
                    Dubai Office
                  </h3>
                  <p
                    class="font-manrope font-normal text-base leading-7 text-[#3F3F46]"
                  >
                    Visa 123 LLC Shams Business Centre Sharjah media City Free
                    Zone Al Messaned Sharjah
                  </p>
                </div>
