      ...
      <div class="w-full max-w-md space-y-8">
        ...
        <div class="space-y-1.5 pt-5">
          ...
          >
            {{
              hasApplicationData
                ? "Complete this to track your application"
                : "Sign up to access visa services"
            }}
          </p>
          ...
          >
            <p class="text-sm text-green-800">
              📋 Application:
              <span class="font-semibold">{{ applicationNumber }}</span>
            </p>
          </div>
        </div>
          ...
          <div class="space-y-4">
            ...
            <div>
              <Input
                ...
                class="w-full h-12 border-gray-200"
                :class="{
                  'border-red-300': passwordTouched && !isPasswordValid,
                }"
              ...
              <div
                v-if="passwordTouched || formData.password"
              ...
              >
                ...
                <div class="space-y-1">
                  ...
                  <div class="flex items-center gap-2">
                    <span
                      v-if="passwordChecks.hasSpecialChar"
                      class="text-green-600 text-xs"
                      >✓</span
                    >
                    <span v-else class="text-gray-400 text-xs">○</span>
            ...
            <div>
              <Input
                ...
                class="w-full h-12 border-gray-200"
                :class="{
                  'border-red-300': confirmPasswordTouched && !passwordsMatch,
                }"
...
const isFormValid = computed(() => {
  const nameAndEmailValid =
    isAuthenticated.value ||
    (formData.fullName.trim() !== "" && formData.email.trim() !== "");

  return nameAndEmailValid && isPasswordValid.value && passwordsMatch.value;
});
