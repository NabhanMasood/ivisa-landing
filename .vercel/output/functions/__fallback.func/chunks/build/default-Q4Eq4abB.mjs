import __nuxt_component_0 from './Header-D8DSIz8l.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const hideFooter = computed(() => {
      return route.path === "/visa-application" || route.path.includes("/visa-") || route.path === "/sign-up" || route.path === "/signup" || route.path === "/additional-info" || route.path === "/my-account";
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!hideHeader.value) {
        _push(ssrRenderComponent(_component_Header, { showAuthButtons: showAuthButtons.value }, null, _parent));
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=default-Q4Eq4abB.mjs.map
