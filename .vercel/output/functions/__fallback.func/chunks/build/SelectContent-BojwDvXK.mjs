        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(SelectContent$1), mergeProps({
              position: "popper",
              class: unref(cn)(
                "fixed z-50 min-w-[8rem] overflow-hidden rounded-md border bg-white text-popover-foreground shadow-md",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(SelectViewport), { class: "p-1 max-h-60 overflow-y-auto" }, {
                  ...
                  return [
                    createVNode(unref(SelectViewport), { class: "p-1 max-h-60 overflow-y-auto" }, {
                      default: withCtx(() => [
                        renderSlot(_ctx.$slots, "default")
                      ]),
                      _: 3
...
//# sourceMappingURL=SelectContent-BojwDvXK.mjs.map
