...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(DropdownMenuRoot), mergeProps(_ctx.$attrs, _attrs), {
...
const DropdownMenu = Object.assign(_sfc_main, { __name: "UiDropdownMenu" });

export { DropdownMenu as default };
//# sourceMappingURL=DropdownMenu-C-dUPqGY.mjs.map
