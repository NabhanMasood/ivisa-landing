...
const _sfc_main = {
  __name: "UiDropdownMenuTrigger",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(DropdownMenuTrigger), mergeProps({ "as-child": "" }, _ctx.$attrs, _attrs), {
...
//# sourceMappingURL=DropdownMenuTrigger-B7jF-YDx.mjs.map
