...
const _imports_1 = publicAssetsURL("/logos/trust-pilot.png");
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    if (selectedFrom.value) {
                                      _push6(`<div class="flex items-center gap-3"${_scopeId5}><span class="text-2xl"${_scopeId5}>${ssrInterpolate(getCountryFlag(selectedFrom.value))}</span><span class="text-base"${_scopeId5}>${ssrInterpolate(selectedFrom.value)}</span></div>`);
                                    } else {
                                      _push6(`<span class="text-gray-500"${_scopeId5}>Select a country</span>`);
                                    }
                                  } else {
                                    return [
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(SelectValue, null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    if (selectedTo.value) {
                                      _push6(`<div class="flex items-center gap-3"${_scopeId5}><span class="text-2xl"${_scopeId5}>${ssrInterpolate(getCountryFlag(selectedTo.value))}</span><span class="text-base"${_scopeId5}>${ssrInterpolate(selectedTo.value)}</span></div>`);
                                    } else {
                                      _push6(`<span class="text-gray-500"${_scopeId5}>Select a country</span>`);
                                    }
                                  } else {
...
//# sourceMappingURL=Hero-CHyeV3Uw.mjs.map
